    ...
    <div className='overflow-x-auto pb-4'>
      <div className='group flex flex-wrap gap-4 mt-4 w-max'>
        {nowPlayingMovies.map((movie)=>(
          <div key={movie.id} className={`relative max-w-40 cursor-pointer transition duration-300 group-hover:not-hover:opacity-40 hover:-translate-y-1   `} onClick={()=>setSelectMovie(movie.id)}>
