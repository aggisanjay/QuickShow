...
const HeroSection = () => {
  ...
  return (
    <div className='flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-[url(/backgroundImage.png)] bg-cover bg-center h-screen'>
      ...
      <h1 className='text-5xl md:text-[70px] md:leading-18 font-semibold max-w-110'>Guradians <br/> of the Galaxy</h1>
      <div className='flex ietms-center gap-4 text-gray-300'>
